...
class JobApplicationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create job_application" do
    assert_difference('JobApplication.count') do
      post job_applications_url, params: { job_application: { additionalinfo: @job_application.additionalinfo, disability: @job_application.disability, gender: @job_application.gender, linkedin: @job_application.linkedin, portfolio: @job_application.portfolio, race: @job_application.race, veteran: @job_application.veteran } }
    end
  ...
  test "should update job_application" do
    patch job_application_url(@job_application), params: { job_application: { additionalinfo: @job_application.additionalinfo, disability: @job_application.disability, gender: @job_application.gender, linkedin: @job_application.linkedin, portfolio: @job_application.portfolio, race: @job_application.race, veteran: @job_application.veteran } }

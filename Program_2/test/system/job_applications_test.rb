...
class JobApplicationsTest < ApplicationSystemTestCase
  ...
  test "creating a Job application" do
    ...
    fill_in "Additionalinfo", with: @job_application.additionalinfo
    fill_in "Disability", with: @job_application.disability
    fill_in "Gender", with: @job_application.gender
    fill_in "Linkedin", with: @job_application.linkedin
    fill_in "Portfolio", with: @job_application.portfolio
    fill_in "Race", with: @job_application.race
    fill_in "Veteran", with: @job_application.veteran
